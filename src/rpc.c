...
// 所有GUID在此处定义为BYTE [16]。 不需要big-endian / little-endian byteswapping.
...
// ReSharper 禁用 CppIncompatiblePointerConversion
static const struct {
...
// ReSharper 恢复 CppIncompatiblePointerConversion
